...
Label dan Kolom Input:

"Angka1" dengan kolom input di sebelahnya, yang digunakan untuk memasukkan angka pertama.
"Angka2" dengan kolom input di sebelahnya, yang digunakan untuk memasukkan angka kedua.
"Hasil" dengan kolom input di bawahnya, yang akan menampilkan hasil dari penjumlahan kedua angka.
Tombol:

"Tambah" untuk melakukan operasi penjumlahan angka pertama dan kedua yang dimasukkan.
"Hapus" untuk menghapus input yang telah dimasukkan.
...
## coding Java Pertambahan Dua Angka
```java
